...
export const Profile: FC = memo(() => {
  return (
    <>
      ...
      <Text
        text={"TypeScript, Reactを主に触っており、最近ではWebパフォーマンス / Developer Experienceに興味があります。"}
      />
      ...
      <Text
        text={
          "2022年からフルタイムでエンジニアとして働き始め、スピード感のある開発をしていく中で、フロントエンドとバックエンド両方の経験をさせていただけたのはとてもいい経験でした。そして2023年、新しい会社にジョインし、Webフロントエンド領域の様々なことに挑戦し、開発者としてレベルアップすることに注力しています。"
        }
      />
